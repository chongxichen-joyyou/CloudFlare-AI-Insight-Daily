...
```
微软推出免费生成式AI入门课程，适合零基础学习构建AI应用。  
设计师黑科技编辑器onlook支持可视化搭建React应用。  
开源项目涵盖AI评估框架、图形编辑器、网络安全工具等热门领域。
```



**AI产品与功能更新**  
1. **[生成式AI入门课程](https://github.com/microsoft/generative-ai-for-beginners)**：微软推出的21堂免费课程，手把手教你构建**生成式AI**应用，适合零基础小白。目前收获8.9万星标，热度爆棚！[点此学习](https://microsoft.github.io/generative-ai-for-beginners/)  
2. **[onlook](https://github.com/onlook-dev/onlook)**：设计师的**黑科技编辑器**！**AI可视化**搭建React应用，连代码都能"**看得见**”✨（⭐19.9k）  
![onlook编辑器界面](https://opengraph.githubassets.com/onlook-dev/onlook)  
（用**视觉化编辑**告别枯燥代码——像搭积木一样开发！）  

---

**AI前沿研究**  
1. **[deepeval评估框架](https://github.com/confident-ai/deepeval)**：专治**大语言模型**的"智商测试仪"，用代码量化AI的靠谱程度，开源界新晋黑马（8869星）。  

---

**开源TOP项目**  
1. **[Graphite图形编辑器](https://github.com/GraphiteEditor/Graphite)**：2025年最炸裂的开源2D设计工具，**节点式编辑**功能让平面设计和数字艺术创作像搭积木一样简单，已获1.7万开发者追捧。  
2. **[PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings)**：**网络安全**必备宝典，涵盖Web渗透测试和CTF的**绕过技巧**与攻击载荷，6.7万星封神！  
3. **[AdminLTE](https://github.com/ColorlibHQ/AdminLTE)**：基于**Bootstrap 5**的免费**后台管理模板**，提供丰富的UI组件和响应式设计，适合快速搭建管理后台。（⭐44,804）  
4. **[twenty](https://github.com/twentyhq/twenty)**：由社区驱动的**Salesforce替代方案**，旨在提供更现代的客户关系管理（CRM）解决方案。（⭐32,817）  
5. **[Actual](https://github.com/actualbudget/actual)**：一款**本地优先**的个人理财应用，适合注重隐私的用户管理财务，已获近2万星标。  

---

**社媒分享**  
1. **[MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)**：全能**社交媒体爬虫**，支持小红书、抖音、B站等平台的笔记、视频及评论抓取，热度超高（2.4万星）。  
2. **[ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook)**：覆盖**小学到大学**的全阶段**PDF教材合集**，堪称学习资源的"**一站式图书馆**”。（⭐42.7k）  
3. **[Project-Ideas-And-Resources](https://github.com/The-Cool-Coders/Project-Ideas-And-Resources)**：程序员练手**宝藏清单**，用**实际项目**点燃你的**编码热情** ❤️（⭐7.4k）  
4. **[tweakcn](https://github.com/jnsahaj/tweakcn)**：一个**可视化无代码主题编辑器**，专为**shadcn/ui组件**设计，让用户无需编程即可轻松定制界面主题，目前已获得5061颗星。  
5. **[gemini-balance](https://github.com/snailyp/gemini-balance)**：提供**Gemini轮询代理服务**，帮助优化API调用负载均衡，适用于需要高效管理Gemini请求的场景，收获2213颗星。">
...
3. **[Project-Ideas-And-Resources](https://github.com/The-Cool-Coders/Project-Ideas-And-Resources)**：程序员练手**宝藏清单**，用**实际项目**点燃你的**编码热情** ❤️（⭐7.4k）  
4. **[tweakcn](https://github.com/jnsahaj/tweakcn)**：一个**可视化无代码主题编辑器**，专为**shadcn/ui组件**设计，让用户无需编程即可轻松定制界面主题，目前已获得5061颗星。  
5. **[gemini-balance](https://github.com/snailyp/gemini-balance)**：提供**Gemini轮询代理服务**，帮助优化API调用负载均衡，适用于需要高效管理Gemini请求的场景，收获2213颗星。</div>
             <div class="content-box" id="outContentBox"><h2>AI洞察周报 2025/7/2</h2>
<blockquote>
<p> <code>AI 周报</code> </p>
</blockquote>
<h3><strong>AI内容摘要</strong></h3>
<pre><code>微软推出免费生成式AI入门课程，适合零基础学习构建AI应用。  
设计师黑科技编辑器onlook支持可视化搭建React应用。  
开源项目涵盖AI评估框架、图形编辑器、网络安全工具等热门领域。
</code></pre>
<p><strong>AI产品与功能更新</strong>  </p>
<ol>
<li><strong><a href="https://github.com/microsoft/generative-ai-for-beginners">生成式AI入门课程</a></strong>：微软推出的21堂免费课程，手把手教你构建<strong>生成式AI</strong>应用，适合零基础小白。目前收获8.9万星标，热度爆棚！<a href="https://microsoft.github.io/generative-ai-for-beginners/">点此学习</a>  </li>
<li><strong><a href="https://github.com/onlook-dev/onlook">onlook</a></strong>：设计师的<strong>黑科技编辑器</strong>！<strong>AI可视化</strong>搭建React应用，连代码都能"<strong>看得见</strong>”✨（⭐19.9k）<br><img src="https://opengraph.githubassets.com/onlook-dev/onlook" alt="onlook编辑器界面"><br>（用<strong>视觉化编辑</strong>告别枯燥代码——像搭积木一样开发！）</li>
</ol>
<hr>
<p><strong>AI前沿研究</strong>  </p>
<ol>
<li><strong><a href="https://github.com/confident-ai/deepeval">deepeval评估框架</a></strong>：专治<strong>大语言模型</strong>的&quot;智商测试仪&quot;，用代码量化AI的靠谱程度，开源界新晋黑马（8869星）。</li>
</ol>
<hr>
<p><strong>开源TOP项目</strong>  </p>
<ol>
<li><strong><a href="https://github.com/GraphiteEditor/Graphite">Graphite图形编辑器</a></strong>：2025年最炸裂的开源2D设计工具，<strong>节点式编辑</strong>功能让平面设计和数字艺术创作像搭积木一样简单，已获1.7万开发者追捧。  </li>
<li><strong><a href="https://github.com/swisskyrepo/PayloadsAllTheThings">PayloadsAllTheThings</a></strong>：<strong>网络安全</strong>必备宝典，涵盖Web渗透测试和CTF的<strong>绕过技巧</strong>与攻击载荷，6.7万星封神！  </li>
<li><strong><a href="https://github.com/ColorlibHQ/AdminLTE">AdminLTE</a></strong>：基于<strong>Bootstrap 5</strong>的免费<strong>后台管理模板</strong>，提供丰富的UI组件和响应式设计，适合快速搭建管理后台。（⭐44,804）  </li>
<li><strong><a href="https://github.com/twentyhq/twenty">twenty</a></strong>：由社区驱动的<strong>Salesforce替代方案</strong>，旨在提供更现代的客户关系管理（CRM）解决方案。（⭐32,817）  </li>
<li><strong><a href="https://github.com/actualbudget/actual">Actual</a></strong>：一款<strong>本地优先</strong>的个人理财应用，适合注重隐私的用户管理财务，已获近2万星标。</li>
</ol>
<hr>
<p><strong>社媒分享</strong>  </p>
<ol>
<li><strong><a href="https://github.com/NanmiCoder/MediaCrawler">MediaCrawler</a></strong>：全能<strong>社交媒体爬虫</strong>，支持小红书、抖音、B站等平台的笔记、视频及评论抓取，热度超高（2.4万星）。  </li>
<li><strong><a href="https://github.com/TapXWorld/ChinaTextbook">ChinaTextbook</a></strong>：覆盖<strong>小学到大学</strong>的全阶段<strong>PDF教材合集</strong>，堪称学习资源的"<strong>一站式图书馆</strong>”。（⭐42.7k）  </li>
<li><strong><a href="https://github.com/The-Cool-Coders/Project-Ideas-And-Resources">Project-Ideas-And-Resources</a></strong>：程序员练手<strong>宝藏清单</strong>，用<strong>实际项目</strong>点燃你的<strong>编码热情</strong> ❤️（⭐7.4k）  </li>
<li><strong><a href="https://github.com/jnsahaj/tweakcn">tweakcn</a></strong>：一个<strong>可视化无代码主题编辑器</strong>，专为<strong>shadcn/ui组件</strong>设计，让用户无需编程即可轻松定制界面主题，目前已获得5061颗星。  </li>
<li><strong><a href="https://github.com/snailyp/gemini-balance">gemini-balance</a></strong>：提供<strong>Gemini轮询代理服务</strong>，帮助优化API调用负载均衡，适用于需要高效管理Gemini请求的场景，收获2213颗星。</li>
</ol>
</div>
...
Description: 21堂课，开启生成式AI构建之旅 🔗 https://microsoft.github.io/generative-ai-for-beginners/
Stars: 89008
...
Description: 2025年开源图形编辑器：面向平面设计、数字艺术及交互式实时动态图形的全方位2D内容创作工具套件 —— 搭载基于节点的程序化编辑功能
Stars: 17493
...
Description: AdminLTE - 基于Bootstrap 5的免费后台管理模板
Stars: 44804
...
Description: 构建由社区驱动的Salesforce现代替代方案
Stars: 32817
...
Description: 设计师的光标 • 开源视觉化氛围编码编辑器 • 用AI可视化构建、设计并编辑你的React应用
Stars: 19929
...
2. **[Graphite图形编辑器](https://github.com/GraphiteEditor/Graphite)**：2025年最炸裂的开源2D设计工具，**节点式编辑**功能让平面设计和数字艺术创作像搭积木一样简单，已获1.7万开发者追捧。  

3. **[deepeval评估框架](https://github.com/confident-ai/deepeval)**：专治**大语言模型**的"智商测试仪"，用代码量化AI的靠谱程度，开源界新晋黑马（8869星）。

1. **[wallet-gen](https://github.com/octra-labs/wallet-gen)**：一个专注于**加密货币钱包生成**的开源项目，适合开发者快速集成钱包功能。（⭐494）

2. **[AdminLTE](https://github.com/ColorlibHQ/AdminLTE)**：基于**Bootstrap 5**的免费**后台管理模板**，提供丰富的UI组件和响应式设计，适合快速搭建管理后台。（⭐44,804）

3. **[twenty](https://github.com/twentyhq/twenty)**：由社区驱动的**Salesforce替代方案**，旨在提供更现代的客户关系管理（CRM）解决方案。（⭐32,817）

1. **[Actual](https://github.com/actualbudget/actual)**：一款**本地优先**的个人理财应用，适合注重隐私的用户管理财务，已获近2万星标。  

2. **[MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)**：全能**社交媒体爬虫**，支持小红书、抖音、B站等平台的笔记、视频及评论抓取，热度超高（2.4万星）。  

3. **[PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings)**：**网络安全**必备宝典，涵盖Web渗透测试和CTF的**绕过技巧**与攻击载荷，6.7万星封神！  

关键词加粗：**本地优先**、**社交媒体爬虫**、**网络安全**、**绕过技巧**。

1. **[ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook)**：覆盖**小学到大学**的全阶段**PDF教材合集**，堪称学习资源的"**一站式图书馆**”。（⭐42.7k）  

2. **[Project-Ideas-And-Resources](https://github.com/The-Cool-Coders/Project-Ideas-And-Resources)**：程序员练手**宝藏清单**，用**实际项目**点燃你的**编码热情** ❤️（⭐7.4k）  

3. **[onlook](https://github.com/onlook-dev/onlook)**：设计师的**黑科技编辑器**！**AI可视化**搭建React应用，连代码都能"**看得见**”✨（⭐19.9k）  

![onlook编辑器界面](https://opengraph.githubassets.com/onlook-dev/onlook)  
（用**视觉化编辑**告别枯燥代码——像搭积木一样开发！）

1. **[tweakcn](https://github.com/jnsahaj/tweakcn)**：一个**可视化无代码主题编辑器**，专为**shadcn/ui组件**设计，让用户无需编程即可轻松定制界面主题，目前已获得5061颗星。  

2. **[gemini-balance](https://github.com/snailyp/gemini-balance)**：提供**Gemini轮询代理服务**，帮助优化API调用负载均衡，适用于需要高效管理Gemini请求的场景，收获2213颗星。">
